...
export default function Project() {
  return (
    <div
      className='container pt-20 sm:pt-10 pb-12 mx-auto align-middle'
      id='projects'
    >
      <div className='flex flex-col items-center mb-4'>
        <p className='text-5xl font-medium md:text-3xl sm:text-3xl text-gray-800 mb-4'>
          Group of projects
        </p>
        <p className='text-3xl font-medium md:text-2xl sm:text-xl text-gray-400 mb-4'>
