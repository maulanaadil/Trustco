      ...
      <Popover className="text-center lg:text-left bg-transparent border-t-2 border-gray-100 text-gray-600">
        <div className="mx-6 lg:mx-28 py-10 text-center md:text-left">
          ...
          "
              ...
              <p className="text-justify">Trusco is a quality modern website creation service that prioritizes quality and was developed by experienced developers and designers.</p>
            </div>
            <div className="">
            ...
            <div className="">
              ...
              <p className="mb-4">
                <Link to="projects" smooth={true} spy={true} className="text-gray-500 hover:text-gray-900 cursor-pointer">
                  Projects
                </Link>
              </p>
            </div>
